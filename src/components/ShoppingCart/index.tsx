...
const productsInCart = [
  ...
  { id: 2, name: "Produto 2", image: MensTreeRunnerNz, price: 75, quantity: 5 },
  { id: 3, name: "Produto 3", image: MensWoolCruiser, price: 85, quantity: 5 },
  {
    id: 4,
    name: "Produto 4",
    ...
    <>
      ...
      >
        ...
        <div
          ...
          } absolute top-0 right-0 bottom-0 text-black bg-white pt-6 transition-all duration-500 ease-in-out w-75 md:w-106`}
        ...
        >
          ...
          <footer className="absolute bottom-0 w-full h-20 p-4">
