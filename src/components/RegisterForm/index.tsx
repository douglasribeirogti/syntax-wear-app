...
export const RegisterForm = () => {
  ...
  return (
    <form className="text-black">
      ...
      {/* Botão de envio */}
      <button className="bg-[#5433EB] text-white font-semibold uppercase rounded-md py-3 transition-all hover:bg-[#4028c7] disabled:opacity-50 w-full cursor-pointer mt-4">  
