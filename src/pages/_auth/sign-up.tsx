...
function RouteComponent() {
  return (
    <section className="min-h-screen w-full flex items-center justify-center bg-[#f5f5f5] p-5">
      <div className="w-112.5 bg-white rounded-2xl p-5 flex flex-col gap-4">
        <Logo />
        <RegisterForm />
        <Separator />
